...
export default function Home({ theme }) {
    ...
    <ul className="contacts">
        ...
        <li style={{background: theme}}><a style={{ color: theme === "wheat" ? "black" : theme === "white" ? "black" : "white", }} className="link github" href="mailto:aiwekhoemicheal@gmail.com">EMAIL</a></li>
